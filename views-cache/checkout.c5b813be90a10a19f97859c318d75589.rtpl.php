								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											...
											<label class="" for="method-pagseguro"><img style="height:64px;" src="/resource/site/img/logo-pagseguro.png">
											</label>
										</p>
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											...
											<label class="" for="method-paypal"><img style="height:64px;" src="/resource/site/img/logo-paypal.png">
											</label>
										</p>
											<div id="payment">
